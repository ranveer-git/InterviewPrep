...
public class KDiffPairs_532 {
    ...
    public static void main(String[] args) {
        KDiffPairs_532 cls = new KDiffPairs_532();
        System.out.println(cls.findPairs(new int[]{1, 3, 5, 4, 1}, 2));
        System.out.println(cls.findPairs(new int[]{1, 3, 5, 4, 2}, 1));
        System.out.println(cls.findPairs(new int[]{1, 3, 1, 5, 4}, 0));
        System.out.println(cls.findPairs(new int[]{1, 3, 1, 5, 4, 3}, 0));
    }
}
